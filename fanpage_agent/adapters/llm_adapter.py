"""LLM adapter — wraps V1 OpenAICompatibleClient for Agents.

Provides-friendly methods that Agents can call to generate
...
class LLMAdapter:
    """Thin wrapper around V1 OpenAICompatibleClient for Agents.
