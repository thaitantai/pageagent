...
def build_parser() -> argparse.ArgumentParser:
    ...
    queue_show = subparsers.add_parser("queue-show", help="Show content queue with filters")
    ...
    queue_enqueue.add_argument("--calendar-id", required=True)
    queue_enqueue.add_argument("--batch-id")
    ...
    queue_approve.add_argument("--calendar-id")
    queue_approve.add_argument("--approved-by", default="admin")
    queue_approve.add_argument("--all", action="store_true", help="Approve all queued items")
    queue_approve.add_argument("--pillar")
    queue_approve.add_argument("--topic")
    ...
    queue_reject.add_argument("--calendar-id")
    queue_reject.add_argument("--reason", default="")
    queue_reject.add_argument("--all", action="store_true", help="Reject all queued items")
    queue_reject.add_argument("--pillar")
    queue_reject.add_argument("--topic")
    ...
    queue_publish.add_argument("--calendar-id")
    queue_publish.add_argument("--pillar")
    queue_publish.add_argument("--topic")
    queue_publish.add_argument("--limit", type=int)
    queue_publish.add_argument("--dry-run", action="store_true", help="Preview without FB API")
    add_store_backend_arg(queue_publish)

    queue_stats = subparsers.add_parser("queue-stats", help="Show queue statistics")
    queue_stats.add_argument("--calendar-file", default=str(DEFAULT_CALENDAR_FILE))
    queue_stats.add_argument("--history-file", default=str(DEFAULT_HISTORY_FILE))
    queue_stats.add_argument("--metrics-file", default=str(DEFAULT_METRICS_FILE))
    add_store_backend_arg(queue_stats)
