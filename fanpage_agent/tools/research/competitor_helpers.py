...
_SKINCARE_CATEGORY_KEYWORDS: set[str] = {
    "skincare", "chăm sóc da", "dưỡng da", "làm đẹp", "beauty",
    "mỹ phẩm", "cosmetic", "da dầu", "da khô", "da mụn",
    "chống lão hóa", "anti-aging", "dưỡng ẩm", "moisturizing",
    "làm trắng", "brightening", "se khít lỗ chân lông",
    "trị mụn", "acne", "thâm nám", "tàn nhang",
    "chống nắng", "sunscreen", "bảo vệ da",
}
...
_FORMAT_PATTERNS: dict[str, list[str]] = {
    "review": [
        "review", "đánh giá", "trải nghiệm", "dùng thử",
        "sau khi dùng", "after", "experience", "honest",
    ],
    "comparison": [
        "so sánh", "vs", "versus", "comparison", "hay",
        "nên chọn", "which one", "khác nhau", "difference",
        "đối đầu", "face-off",
    ],
    "tutorial": [
        "cách dùng", "how to", "hướng dẫn", "guide",
        "các bước", "step", "routine", "quy trình",
        "tips", "mẹo", "tutorial",
    ],
    "ingredient_deep_dive": [
        "thành phần", "ingredient", "bảng thành phần",
        "incidecoder", "phân tích", "skincare decoder",
        "hoạt chất", "nồng độ", "concentration",
    ],
    "deal_promotion": [
        "deal", "sale", "giảm giá", "discount", "coupon",
        "mã", "voucher", "khuyến mãi", "flash sale",
        "mua 1 tặng 1", "free ship", "freeship",
    ],
    "qa": [
        "faq", "hỏi đáp", "q&a", "hỏi", "trả lời",
        "ask", "answer", "question", "giải đáp",
    ],
    "unboxing": [
        "unbox", "unboxing", "mở hộp", "open box",
...
def estimate_price_positioning(text: str) -> str:
    ...
    text_lower = text.lower()
    premium_words = [
        "cao cấp", "premium", "luxury", "đắt", "xịn",
        "high-end", "sang trọng", "đẳng cấp",
    ]
    budget_words = [
        "rẻ", "bình dân", "giá tốt", "tiết kiệm", "affordable",
        "hợp túi tiền", "giá rẻ", "dưới 100k", "dưới 200k",
    ]
    mid_words = [
        "tầm trung", "giá hợp lý", "đáng đồng tiền",
        "worth", "quality price",
    ]
...
def estimate_content_tone(text: str, format_type: str) -> str:
    ...
    scientific_words = [
        "thành phần", "nghiên cứu", "study", "clinical",
        "dermatologist", "bác sĩ da liễu", "khoa học",
        "active ingredient", "hoạt chất", "nồng độ",
    ]
    educational_words = [
        "cách", "hướng dẫn", "guide", "tips", "mẹo",
        "nên", "không nên", "lưu ý", "cần biết",
    ]
    entertaining_words = [
        "xu hướng", "hot", "trend", "must-have",
        "đỉnh", "chất", "xuất sắc", "tuyệt vời",
    ]
