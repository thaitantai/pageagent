...
""",
        ...
        self.assertEqual(payload["summary"]["publish_blockers"], 1)
        self.assertIn("approval_status_not_approved", payload["publish_blockers"]["items"][0]["reason_codes"])
        ...
        self.assertIn("Publish blockers", sent_message["text"])
        self.assertIn("approval_status_not_approved", sent_message["text"])
