"""Tests for core framework — types, agent base, bus."""
...
from fanpage_agent.core.harness import AgentHarness, HarnessPolicy
...
class TestContentPackage:
    ...
    def test_best_variant_by_score(self):
        from fanpage_agent.core.types import ContentVariant
