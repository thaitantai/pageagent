"""Tests for multi-page support — PageRegistry, per-page pipeline, main.py."""
...
class TestGetRegistry:
    def test_get_registry_from_settings(self):
        from fanpage_agent.adapters.page_registry import get_registry
...
class TestMainMultiPage:
    ...
    def test_daemon_cli_shows_pages(self):
        ...
        from fanpage_agent.main import cli
        import sys
